...
class ToolKit implements Kit {
  ...
  Future<void> setApiKey(
    ...
    final result = await methodChannel.invokeMethod<bool>('setApiKey', {
    ...
    AmapKit().initialized = result ?? false;
  }

  /// 计算两点间距离 单位：米
  Future<double?> calculateLineDistance(LatLng ll1, LatLng ll2) async {
    return await methodChannel.invokeMethod('calculateLineDistance', {
      'll1': ll1.toJson(),
      'll2': ll2.toJson(),
    });
  }
